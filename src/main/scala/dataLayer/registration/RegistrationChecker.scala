...
class RegistrationChecker(private val userID: String, private val password: String, private val userType: Int, private val region: String, private val city: String):
   ...
   * @return
   */
  def checkUserID(userID: String): String =
    userID match
   ...
   * @return
   */
  def checkPassword(password: String): String =
    password match
   ...
   * @return
   */
  def checkUserType(userType: Int): String =
   ...
   * @return
   */
  def checkCityRegionMatch(city: String, region: String): String =
    if regionCityMap.contains(region.toLowerCase.capitalize) then
   ...
   * @return
   */
  def checkDuplicatedUserID(userID: String): Boolean =
