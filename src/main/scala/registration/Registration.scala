...
object Registration:
  ...
  def signUP(userID: String, password: String, userType: String, city: String, region: String): String =
    val cityRegionVerification = regionCityMap(region).contains(city)
    var verificationMessage = ""
    cityRegionVerification match
      case true =>
